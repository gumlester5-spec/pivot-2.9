...
export const ShoppingCartIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.328 1.095-.826l1.724-6.897c.063-.252.097-.514.097-.777 0-.43.146-.857.437-1.199M7.5 14.25v-6.375c0-.621.504-1.125 1.125-1.125h9.375" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.226a11.942 11.942 0 013.59 0c.55.219 1.02.684 1.11 1.226.09.542.062 1.096-.088 1.616a11.942 11.942 0 01-1.616 2.376c-.466.562-1.028.986-1.664 1.258a11.942 11.942 0 01-2.032 0c-.636-.272-1.198-.696-1.664-1.258a11.942 11.942 0 01-1.616-2.376c-.15-.52-.178-1.074-.088-1.616zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 10.5a11.942 11.942 0 011.616-2.376c.466-.562 1.028-.986 1.664-1.258a11.942 11.942 0 012.032 0c.636.272 1.198.696 1.664 1.258a11.942 11.942 0 011.616 2.376m0 3a11.942 11.942 0 01-1.616 2.376c-.466.562-1.028.986-1.664 1.258a11.942 11.942 0 01-2.032 0c-.636-.272-1.198-.696-1.664-1.258a11.942 11.942 0 01-1.616-2.376M15 3.75a11.942 11.942 0 012.376 1.616c.562.466.986 1.028 1.258 1.664a11.942 11.942 0 010 2.032c-.272.636-.696 1.198-1.258 1.664a11.942 11.942 0 012.376-1.616m-6 0a11.942 11.942 0 01-2.376-1.616c-.562-.466-.986-1.028-1.258-1.664a11.942 11.942 0 010-2.032c.272-.636.696-1.198 1.258-1.664a11.942 11.942 0 012.376-1.616" />
    </svg>
);
...
export const CreditCardIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3.75m-3.75 2.25h13.5m0-13.5V21a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 21V5.25a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 5.25z" />
    </svg>
);
