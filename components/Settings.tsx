...
import { SunIcon, MoonIcon, ComputerDesktopIcon, ArrowPathIcon } from './icons';
...
const Settings: React.FC<SettingsProps> = ({ user, settings, updateSettings, refreshSummary }) => {
        ...
        <div className="flex items-center space-x-2 rounded-lg bg-gray-100 dark:bg-gray-700 p-1">
          {themeOptions.map(option => (
            <button
              ...
              className={`w-full flex items-center justify-center px-3 py-2 text-sm font-medium rounded-md transition-colors ${theme === option.value
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8">
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
            <h3 className="text-sm font-medium text-gray-900 dark:text-gray-200 mb-3">Mantenimiento</h3>
            <button
              type="button" // Changed to type="button" to prevent form submission
              onClick={() => refreshSummary && refreshSummary()}
            ...
            >
              ...
              Recalcular Saldos y Ganancias
            </button>
            <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
              Úsala si notas inconsistencias en tus números. Esto volverá a sumar todas tus transacciones.
            </p>
          </div>
